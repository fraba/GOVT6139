...
- Download and open with JASP *aes22_pol_part.csv*


## Task: With JASP provide visual and statistical support to these two hypotheses
...
2. Aboriginal or Torres Strait Islander are less engaged in politics. 
  ...
  * (You might need to create an index here by summing multiple variables)
