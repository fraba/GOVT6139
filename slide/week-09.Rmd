...
- Explain, do not list! (Avoid bullet points)

- Unpack to the lowest possible level allowed by the word limit.

  - If you can't unpack because you don't have enough room, you are trying to explain too much! Reduce the scope.

- Theory doesn't cause events! It explains them. Make sure that this is reflected in your language. Do not say: People behave this

- Avoid quotes!

- Research design is an interdisciplinary language
