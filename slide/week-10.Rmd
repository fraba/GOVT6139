...
This is the equation of the **model** for the line that **best fit** the points. 
...
- A $\widehat{hat}$ identifies *estimated* values (estimated by the model)
...
.pull-right[.center[<img src = 'https://upload.wikimedia.org/wikipedia/commons/5/53/Linear_least_squares_example2.png' width = '60%'></img>]]

---

.center[<img src = '../img/blackwell-01' width = '100%'></img>]
