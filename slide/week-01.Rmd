...
We have four events scheduled in August and September - check them out!
...
.center[<img src = 'https://upload.wikimedia.org/wikipedia/commons/5/57/NotebookLM_logo.svg' width = '40%'>]

### Week 10 Quantitative Data Analysis with JASP

.center[<img src = 'https://upload.wikimedia.org/wikipedia/commons/0/0d/JASP_logo.svg' width = '10%'>]
...
1. **Wished they had taken this course first** - Skills learned were immediately applicable to other subjects in their program
2. **Appreciated the balance of art and science** - Course effectively combined theoretical knowledge with practical research skills
3. **Recognised thoughtful course design** - Content was carefully selected and well-structured throughout
4. **Course was accessible despite complexity** - Material remained digestible even for students with limited research experience
5. **Developed transferable critical thinking skills** - Students plan to apply learned techniques in future work and studies

---

## What some GOVT6139 students had mixed feelings about or didn't like last year

1. **Course scheduling challenges** - Only offered in first semester forces students to enrol early without knowing their research interests or dissertation plans

2. **Class size too large** - Limited opportunities for meaningful peer discussion and individualised feedback from instructor

3. **Pace sometimes too fast** - Students struggled to keep up with content delivery in some sessions

4. **R Studio session ineffective** - Two hours insufficient to learn software; suggested broader overview of research tools instead

5. **Peer review guidance lacking** - Students wanted clearer instructions on how to provide quality feedback to classmates

---

6\. **Assignment length concerns** - Research proposal considered too long for the assessment type; suggested reducing word count

7\. **Need for more practical examples** - Students wanted case studies linked to each topic for deeper understanding
...
- An advanced qualitative methods or statistics course (Will do some #Rstat in week 10 but you should consider [Data Analytics for Social Research SSPS6006](https://www.sydney.edu.au/courses/units-of-study/2024/ssps/ssps6006.html) for a dedicated unit)
...
**Week 2**: The Selection of a Research Approach + Guest lecture w/t Inessa De Angelis (Uni Toronto)

**Week 3**: Review of the Literature (NotebookLM in-class activity)
...
* Attend at least 90% of the seminars (e.g., if you can't attend email me so I can set you as an apology!)
...
* Let's check Canvas [assessment overview page](https://canvas.sydney.edu.au/courses/65715/pages/assessment-overview?module_item_id=2788752)

* Let's check Canvas [assignment page](https://canvas.sydney.edu.au/courses/65715/assignments)

* Let's check Canvas [calendar page](https://canvas.sydney.edu.au/calendar?include_contexts=course_65715#view_name=month&view_start=2025-08-01)

* Let's check Canvas [due dates (syllabus) page](https://canvas.sydney.edu.au/courses/65715/assignments/syllabus)
...
Let's check [this Canvas page](https://canvas.sydney.edu.au/courses/65715/pages/use-of-generative-ai-and-other-marvels?module_item_id=2788753)
...
One of the best way to understand the working of any language model available in 2025 is to think about *compression algorithms* (although many will contest this analogy!).
...
### How are we going to use GenAI in class?

- We are going to use Google's NotebookLM for literature review tasks. 

- We are going to provide NotebookLM the context where to find and organise the information we want. 

- We do this by uploading a few papers and documents before starting to ask the questions.

- We are NOT going to ask: find me the relevant literature.

- Instead we are going to say: here the literature, find me relevant information in there!
...
.center[<img src = '../img/sres-checkin-screenshot.png' width = '60%'>]
