...
- Discussions (including on readings): Discussions will generally be prompted by questions you will be required to answer through Canvas, Mentimeter, Padlet;
...
- Attend class in-person or (only if authorised by the university) via Zoom. If you attend via Zoom and you are not RE, your attendance will not count towards attendance requirements (90% of classes).

- Do the readings before coming to class and come to class prepared to contribute to the discussion and share reflections on the readings.
