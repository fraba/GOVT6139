...
> Find an example of an abstract from an empirical study in your field. Highlights the **five components** that you find in the abstract. What elements are present, and what elements are missing?
...
* Four-part deficiencies model
  ...
  * Evidence from the literature justifying the problem
  * Deficiencies in the evidence
  * The importance of the problem for audiences
