...
## 6. Can we trust survey research?
...
## Types of Surveys: Overview

#### Interviewer-administered  surveys.
- e.g., in-person surveys, telephone surveys
- The interviewer asks questions and records the responses

#### Self-administered surveys
- e.g., mail surveys, internet surveys
- The respondents read questions and record their answers

---

## Pros and cons of different survey types

| Mode         | Pros                                                                           | Cons                                                                                                     |
| ------------ | ------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------- |
| Online       | • Cheap<br>• Less social desirability bias                                           | • Difficult to get a representative sample (e.g. older people excluded)<br>• What is the sampling frame? |
| Mail         | • Cheap<br>• Less social desirability bias                                     | • Response rate<br>• Time consuming                                                                      |
| Telephone    | • Cheaper than face-to-face<br>• Relatively high response rate<br>• Completion | • Social desirability bias<br>• More expensive<br>• Representative samples?                              |
| Face-to-face | • Relatively high response rate<br>• Completion                                | • Social desirability bias<br>• Most expensive       

---

## World Values Survey: Sampling design (Indonesia)

1. **First stage**: We begin with selecting a sample of provinces (the primary sampling units are provinces). Because of different numbers of population between Java and Out of Java, we use sample fraction, where 6 provinces for Java and 4 provinces for Out of Java.
2. **Second stage**: Select a sample of Regencies or Districts within the provinces selected in
the first stage (the second-stage sampling units are Regencies or Districts).
3. **Third stage**: Select a sample of municipalities and sub-districts within the Regencies or Districts selected in the second stage (the third-stage sampling units are Municipalities or sub-districts).
4. **Fourth stage**: Select a sample of Village within municipalities and sub-districts selected in the third-stage (the fourth-stage sampling units are Village),
5. **Fifth stage**: Select a sample of blocks within the selected Villages in the fourth-stage, and
6. **Sixth stage**: Select a sample of people within the selected families (Households).

---

## Survey research: Potential researcher challenges

#### Sampling Frame does not reflect population
- E.g. a list of landline phone numbers that disproportionately excludes younger people (or mobile phone numbers - older people)
#### Social desirability bias
- Presence of interviewer (phone / face-to-face) influences interviewee to give socially desirable response (e.g. sexism / racism)
#### Non-response bias
- E.g. individuals that respond to the survey have higher levels of education than those that do not respond
#### How to maximise response rate
- Big challenge for survey researchers around the world, becoming harder to get people to respond to surveys
- Participant incentives (e.g. financial incentive $20)
- Participant reminders

---

<img src = '../img/aes-response-rate-table.png' width = '100%'></img>
...
- Some people have responded to polling failures by saying that we cannot trust all survey research

- But it’s not a case of ALL survey research can be trusted or ALL survey research cannot be trusted

- Rather, to evaluate survey research need to:

    - assess how survey was conducted – ask questions about methodology (any academic publication, e.g. journal article should include this information)
    
    - Evaluate any strengths and weaknesses of the approach used
    
    - And therefore what inferences can/cannot be drawn based on that approach
...
#### A few questions for the consumer of survey / poll research:

- What sampling approach was used – can the results be considered representative of a population? What population?

- How and when was the survey administered?

- What were the specific questions asked? Are the questions (measures) a good fit for the concepts? (validity)

- What was the sample size?

- What was the response rate?

- What is the margin of error? Does that have implications for the question of interest - e.g. for many research questions a 2% margin of error will not make a substantive difference to findings, but for predicting election results, 2% error can be the difference between winning/losing
